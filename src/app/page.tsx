  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <section className="relative flex flex-col items-center justify-center overflow-hidden py-24 md:py-36">
          <div className="absolute inset-0 z-0">
            <Image
              ...
              fill
              className="object-cover brightness-[0.4] object-bottom"
              priority
            />
          ...
          <div className="container relative z-10 mx-auto px-4 text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-xl text-emerald-50/70 md:text-2xl">
              Join a thriving community of remote workers exploring the beauty of
              God&apos;s Own Country
            </p>
            <div className="flex justify-center md:hidden gap-3">
              ...
              <Button
                size="lg"
                className="bg-emerald-600 hover:bg-emerald-700 px-5 group flex justify-center "
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className=" text-emerald-400 hover:text-emerald-400 hover:pointer-fine px-5"
              >
            ...
            <div className="mt-16 py-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-emerald-100">
        ...
        <section className="bg-white py-20">
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-3xl text-center">
              <Badge className="mb-4 bg-emerald-100 text-emerald-700 px-3 py-1">
                Our Story
              </Badge>
              ...
              <p className="mb-8 text-lg leading-relaxed text-gray-600">
                Digital Nomads Kerala is a vibrant community of remote workers,
                freelancers, entrepreneurs, and travelers who have chosen Kerala
                as their base. We connect like-minded individuals, share
                resources, organize meetups, and help each other navigate the
                beautiful chaos that is Kerala.
              </p>
              <div className="relative mb-12 mt-16 overflow-hidden rounded-xl border border-emerald-100 bg-emerald-50 p-6 shadow-sm">
                ...
                <p className="relative z-10 text-lg font-medium italic text-emerald-800">
                  &quot;Our mission is to create a supportive ecosystem for
                  digital nomads in Kerala, promoting sustainable travel, cultural
                  exchange, and professional growth while exploring the rich
                  heritage and natural beauty of God&apos;s Own Country.&quot;
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                <div className="rounded-lg bg-white p-6 shadow-sm transition-all hover:shadow-md border border-emerald-50">
                  ...
                  <p className="text-gray-600">
                    Connect with nomads from around the world
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm transition-all hover:shadow-md border border-emerald-50">
                  <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
                  ...
                  <p className="text-gray-600">
                    Learn and grow with fellow professionals
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm transition-all hover:shadow-md border border-emerald-50">
                  <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100 text-emerald-600">
                  ...
                  <p className="text-gray-600">
                    Get help navigating life in Kerala
                  </p>
                </div>
              </div>
            </div>
        ...
        <section
          id="join"
          className="relative bg-emerald-900 py-20 text-white overflow-hidden"
        >
          ...
          <div className="container relative mx-auto px-4 text-center">
            <Badge className="mb-4 bg-emerald-800 text-emerald-200 border-emerald-700 px-3 py-1">
              Get Connected
            </Badge>
            ...
            <p className="mb-10 mx-auto max-w-2xl text-lg text-emerald-200">
              Connect with fellow digital nomads, get local tips, find
              accommodation, and stay updated on upcoming events by joining our
              Telegram group.
            </p>
            ...
            <div className="mx-auto max-w-md rounded-xl bg-white/10 backdrop-blur-sm p-8 border border-emerald-700/50 shadow-lg">
              ...
              <p className="mb-6 text-emerald-200">
                Join our active Telegram group to connect instantly with nomads
                currently in Kerala
              </p>
              <Button
                size="lg"
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div className="group rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg border border-emerald-50 hover:border-emerald-100">
                ...
                <p className="text-gray-600 mb-4">
                  Discover the best cafes and coworking spaces with reliable WiFi
                  throughout Kerala.
                </p>
              ...
              <div className="group rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg border border-emerald-50 hover:border-emerald-100">
                ...
                <p className="text-gray-600 mb-4">
                  Participate in skill-sharing sessions, workshops, and networking
                  events.
                </p>
                <p className="text-sm font-medium text-emerald-600 flex items-center">
                  Learn more
              ...
              <div className="group rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg border border-emerald-50 hover:border-emerald-100">
                ...
                <p className="text-gray-600 mb-4">
                  Connect with fellow nomads through regular social gatherings and
                  adventures.
                </p>
                <p className="text-sm font-medium text-emerald-600 flex items-center">
                  Learn more
              ...
              <div className="group rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg border border-emerald-50 hover:border-emerald-100">
                ...
                <p className="text-gray-600 mb-4">
                  Get insider knowledge on accommodation, transportation, and
                  hidden gems.
                </p>
                <p className="text-sm font-medium text-emerald-600 flex items-center">
                  Learn more
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1" className="border-emerald-200">
                  ...
                  <AccordionContent className="text-gray-600">
                    Anyone who works remotely or is location-independent and is
                    currently in Kerala or planning to visit. We welcome digital
                    nomads, remote workers, freelancers, entrepreneurs, and
                    travelers from all backgrounds and nationalities.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-2" className="border-emerald-200">
                  ...
                  <AccordionContent className="text-gray-600">
                    Popular spots include Kochi (Fort Kochi), Varkala, Kovalam,
                    Alleppey, Munnar, and Wayanad. Each offers different vibes -
                    from beach towns to hill stations. Kochi has the most
                    developed infrastructure for remote workers.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-3" className="border-emerald-200">
                  ...
                  <AccordionContent className="text-gray-600">
                    Internet connectivity varies by location. Major towns and
                    cities have reliable 4G coverage and fiber connections. Our
                    community maintains an updated list of cafes and coworking
                    spaces with good WiFi. We recommend having a backup mobile
                    hotspot for important calls.
                  </AccordionContent>
                </AccordionItem>
                <AccordionItem value="item-4" className="border-emerald-200">
                  ...
                  <AccordionContent className="text-gray-600">
                    While we&apos;re not visa experts, our community members often
                    share their experiences with visa runs and extensions. We can
                    point you to reliable resources and connect you with others
                    who have navigated the visa process.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-4xl rounded-2xl bg-gradient-to-r from-emerald-700 to-emerald-600 p-8 md:p-12 shadow-lg text-white text-center">
              ...
              <p className="mb-8 text-lg text-emerald-100">
                Connect with fellow digital nomads and start your Kerala adventure
                today
              </p>
            </div>
          </div>
